...
window.NAC_EXPERIENCE = {
    ...
    products: [
        ...
        { id: "makai-ka-atta", name: "Makai ka Atta", price: 210, unit: "kg", image: "img/makai-atta.svg", tag: "Fresh", description: "Fresh ground corn (maize) flour - perfect for makai ki roti and traditional dishes." },
        { id: "jo-ka-atta", name: "Jo ka Atta", price: 280, unit: "kg", image: "img/jo-atta.svg", tag: "Healthy", description: "Wholesome barley (jo) flour, rich in fibre - healthy and traditionally ground." },
        { id: "chawal-ka-atta", name: "Chawal ka Atta", price: 300, unit: "kg", image: "img/chawal-atta.svg", tag: "Special", description: "Fine rice flour (chawal ka atta) for baking, traditional sweets and crispy snacks." },
        { id: "gandum-ka-dalia", name: "Gandum ka Dalia", price: 220, unit: "kg", image: "img/gandum-dalia.svg", tag: "Healthy", description: "Coarse-ground cracked wheat dalia - a wholesome, fibre-rich breakfast choice." },
        { id: "jo-ka-dalia", name: "Jo ka Dalia", price: 360, unit: "kg", image: "img/jo-dalia.svg", tag: "Premium", description: "Cracked barley dalia, full of fibre and nutrition - traditionally ground and pure." },
        { id: "bajre-ka-atta", name: "Bajre ka Atta", price: 200, unit: "kg", image: "img/bajra-atta.svg", tag: "Winter Favourite", description: "Pearl millet (bajra) flour - a healthy, warming choice for bajra roti in winter." },
    ],
